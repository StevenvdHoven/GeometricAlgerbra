...
void Game::InitializeGameEngine()
{
	...
	m_pGameManager = std::make_unique<GameManager>();
	m_pGameManager->Init();
}
...
{
	m_pGameManager->Update(elapsedSec);
}
